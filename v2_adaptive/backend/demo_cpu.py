"""
DEMO: CPU-Only Pipeline
Run this in one terminal while demo_gpu.py runs in another to show the speed difference.
"""
import cv2
import time
import os
...
def run_cpu(video_path: str):
    print(f"\n{'='*60}")
    print(f"  ██  CPU-ONLY PIPELINE  ██")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="CPU Demo")
